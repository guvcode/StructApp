...
| REFACTOR-001 | Tech debt | Replace hardcoded status string literals with canonical `InspectionStatus`, `TimesheetStatus`, `PriorityTier`, `RemediationStatus` enums across 12 form/page files | Low | 2026-07-10 | 🟩 COMPLETED |
